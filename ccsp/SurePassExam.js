const questionsData = [
    {
        ...
        "中文题目与选项": "以下所有方法都是为了提高云数据的可移植性和减少供应商锁定风险的技术，除了：\n(A) 确保没有迁移的物理限制\n(B) 在整个云操作中广泛使用 DRM 和 DLP 解决方案\n(C) 确保合同条款有利于数据可移植性\n(D) 避免使用专有数据格式",
        "答案": "B",
        "来源页码": 1
    },
    {
        ...
        "中文题目与选项": "在以下哪种云计算模式中，云客户对其数据和系统拥有最大的控制权，而云提供商承担的责任最少？\n(A) IaaS（基础设施即服务）\n(B) SaaS（软件即服务）\n(C) 社区云\n(D) PaaS（平台即服务）",
        "答案": "A",
        "来源页码": 1
    },
    {
        ...
        "中文题目与选项": "以下所有措施都是用于防御外部攻击者以保护云运行的对策，除了：\n(A) 持续监控异常活动\n(B) 详细且广泛的背景调查\n(C) 定期且详细的配置/变更管理活动\n(D) 加固设备和系统，包括服务器、主机、管理程序和虚拟机",
        "答案": "B",
        "来源页码": 1
    },
    {
        ...
        "中文题目与选项": "以下哪项是托管服务提供商（MSP）的显著特征？\n(A) 能够为客户远程监控和管理对象，并主动维护这些受管理对象\n(B) 仅有某种形式的帮助台但没有网络运营中心（NOC）\n(C) 能够为客户远程监控和管理对象，但仅被动维护这些受管理对象\n(D) 拥有某种形式的 NOC，但没有帮助台",
        "答案": "A",
        "来源页码": 1
    },
    {
        ...
        "中文题目与选项": "在以下哪种云服务模型中，客户需要自行维护操作系统（OS）？\n(A) IaaS（基础设施即服务）\n(B) CaaS（容器即服务）\n(C) PaaS（平台即服务）\n(D) SaaS（软件即服务）",
        "答案": "A",
        "来源页码": 1
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "以下哪一个 ITIL 组件是对组织使用和依赖的所有已部署和配置资源进行持续迭代跟踪的过程，无论这些资源托管在传统数据中心还是云中？\n(A) 问题管理\n(B) 连续性管理\n(C) 可用性管理\n(D) 配置管理",
        "答案": "D",
        "来源页码": 2
    },
    {
        ...
        "中文题目与选项": "以下哪个角色负责创建云组件以及对服务进行测试和验证？\n(A) 云审计员\n(B) 跨云提供商\n(C) 云服务经纪人\n(D) 云服务开发人员",
        "答案": "D",
        "来源页码": 2
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "令牌化需要两个不同的________。\n(A) 人员\n(B) 身份验证因素\n(C) 加密密钥\n(D) 数据库",
        "答案": "D",
        "来源页码": 3
    },
    {
        "题号": "14",
        "英文题目与选项": "A variety of security systems can be integrated within a network—some that just monitor for threats and issue alerts, and others that take action based on signatures, behavior, and other types of rules to actively stop potential threats.\nWhich of the following types of technologies is best described here?\n(A) IDS\n(B) IPS\n(C) Proxy\n(D) Firewall",
        "中文题目与选项": "各种安全系统可以集成到网络中——有些仅监控威胁并发出警报，而另一些则根据特征、行为和其他规则主动阻止潜在威胁。\n以下哪种技术最符合上述描述？\n(A) 入侵检测系统（IDS）\n(B) 入侵防御系统（IPS）\n(C) 代理服务器（Proxy）\n(D) 防火墙（Firewall）",
        "答案": "B",
        "来源页码": 3
    },
    {
        "题号": "15",
        "英文题目与选项": "Which of the following types of SOC reports would be most likely kept confidential by a cloud service provider?\n(A) SOC 3\n(B) SOC 1 Type 2\n(C) SOC 2 Type 2\n(D) SOC 1 Type 1",
        "中文题目与选项": "以下哪种 SOC（服务组织控制）报告最有可能被云服务提供商保密？\n(A) SOC 3 报告\n(B) SOC 1 Type 2 报告\n(C) SOC 2 Type 2 报告\n(D) SOC 1 Type 1 报告",
        "答案": "C",
        "来源页码": 4
    },
    {
        "题号": "16",
        "英文题目与选项": "Cryptographic keys for encrypted data stored in the cloud should be ________.\n(A) Not stored with the cloud provider\n(B) Generated with redundancy\n(C) At least 128 bits long\n(D) Split into groups",
        "中文题目与选项": "存储在云中的加密数据的加密密钥应当________。\n(A) 不与云服务提供商一起存放\n(B) 生成冗余密钥\n(C) 至少 128 位长\n(D) 分组存放",
        "答案": "A",
        "来源页码": 4
    },
    {
        ...
        "中文题目与选项": "下列哪项最能准确描述云承运商（cloud carrier）？\n(A) 在云提供商与云消费者之间提供连接和传输服务的中介\n(B) 负责向消费者提供云服务的个人或实体\n(C) 负责通过互联网传输数据的个人或实体\n(D) 负责为客户保持云服务运行的个人或实体",
        "答案": "A",
        "来源页码": 4
    },
    {
        ...
        "中文题目与选项": "以下哪一项不是访问控制（access control）的组成部分？\n(A) 记账（Accounting）\n(B) 联邦（Federation）\n(C) 授权（Authorization）\n(D) 认证（Authentication）",
        "答案": "B",
        "来源页码": 4
    },
    {
        ...
        "中文题目与选项": "云系统日益被组织用于业务连续性与灾难恢复（BCDR）方案。云计算的哪个特性使其在 BCDR 方面最具吸引力？\n(A) 按需自助服务\n(B) 可计量服务\n(C) 可移植性\n(D) 广泛的网络访问",
        "答案": "B",
        "来源页码": 4
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "DLP（数据防泄漏）解决方案可以帮助防止以下哪种导致的数据丢失？\n(A) 无意泄露\n(B) 自然灾害\n(C) 随机化\n(D) 设备故障",
        "答案": "A",
        "来源页码": 5
    },
    {
        ...
        "中文题目与选项": "哪种实验性技术可能实现无需先解密即可处理加密数据的能力？\n(A) 一次性密码本\n(B) 链路加密\n(C) 同态加密\n(D) AES",
        "答案": "C",
        "来源页码": 5
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在需要从数据集中移除敏感数据但又必须保留映射回原始值能力的情况下，哪种数据保护策略最有用？\n(A) 掩码（Masking）\n(B) 代币化（Tokenization）\n(C) 加密（Encryption）\n(D) 匿名化（Anonymization）",
        "答案": "B",
        "来源页码": 6
    },
    {
        ...
        "中文题目与选项": "在 STRIDE 威胁模型中，字母 D 代表什么概念？\n(A) 拒绝服务（Denial of service）\n(B) 分布式（Distributed）\n(C) 数据泄露（Data breach）\n(D) 数据丢失（Data loss）",
        "答案": "A",
        "来源页码": 6
    },
    {
        ...
        "中文题目与选项": "ITIL 的哪个组件涉及处理任何可能影响内部或外部用户服务的事项？\n(A) 事件管理（Incident management）\n(B) 部署管理（Deployment management）\n(C) 问题管理（Problem management）\n(D) 变更管理（Change management）",
        "答案": "A",
        "来源页码": 6
    },
    {
        ...
        "中文题目与选项": "DLP（数据丢失防护）解决方案有助于防止哪种原因导致的数据丢失？\n(A) 设备故障\n(B) 随机化\n(C) 无意泄露\n(D) 自然灾害",
        "答案": "C",
        "来源页码": 6
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "以下哪个司法管辖区缺乏涵盖数据隐私和个人可识别信息（PII）保护的全面国家政策？\n(A) 欧盟\n(B) 亚太经济合作组织\n(C) 美国\n(D) 俄罗斯",
        "答案": "C",
        "来源页码": 7
    },
    {
        ...
        "中文题目与选项": "以下哪一项属于管理角色，而不是技术角色，与数据管理和监督相关？\n(A) 数据所有者\n(B) 数据处理者\n(C) 数据库管理员\n(D) 数据保管人",
        "答案": "A",
        "来源页码": 7
    },
    {
        ...
        "中文题目与选项": "在云环境中，可以在不同层级设置资源使用限制，以确保没有任何实体会消耗影响其他云客户的资源。\n以下哪一项不是限制所涵盖的单位？\n(A) 虚拟机监控程序（Hypervisor）\n(B) 云客户\n(C) 虚拟机\n(D) 服务",
        "答案": "A",
        "来源页码": 7
    },
    {
        ...
        "中文题目与选项": "ITIL 的哪个组件涉及在意外中断或事件后规划服务恢复？\n(A) 连续性管理\n(B) 问题管理\n(C) 配置管理\n(D) 可用性管理",
        "答案": "A",
        "来源页码": 7
    },
    {
        ...
        "中文题目与选项": "IRM（信息权限管理）解决方案允许组织在数据使用上施加不同于传统安全控制的限制。以下哪项控制是 IRM 可以实现而传统安全控制无法实现的？\n(A) 复制\n(B) 读取\n(C) 删除\n(D) 打印",
        "答案": "D",
        "来源页码": 8
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "静态应用安全测试（SAST）为测试人员提供哪项独特的功能，使其区别于其他常见的安全测试方法？\n(A) 实时测试\n(B) 源代码访问\n(C) 生产系统扫描\n(D) 注入尝试",
        "答案": "B",
        "来源页码": 8
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在 IaaS 中，将对象存储而非卷存储用于应用使用和依赖时，潜在问题是什么？\n(A) 对象存储仅针对小文件进行了优化。\n(B) 对象存储是独立系统，其数据一致性取决于复制机制。\n(C) 对象存储可能存在可用性问题。\n(D) 对象存储依赖于主机服务器的访问控制。",
        "答案": "B",
        "来源页码": 8
    },
    {
        "题号": "40",
        "英文题目与选项": "Cryptographic keys should be secured ________.\n(A) To a level at least as high as the data they can decrypt\n(B) In vaults\n(C) With two-person integrity\n(D) By armed guards",
        "中文题目与选项": "加密密钥应被保护到什么程度？\n(A) 至少应与它们能够解密的数据具有相同的安全等级\n(B) 存放在保险库中\n(C) 通过两人完整性制度保护\n(D) 由武装警卫保护",
        "答案": "A",
        "来源页码": 9
    },
    {
        ...
        "中文题目与选项": "随着您的应用程序和系统迁移到云环境，新的首席信息安全官（CISO）更加重视监管合规。以下哪一项在制定监管合规项目计划时不会成为主要关注点？\n(A) 传输中的数据\n(B) 使用中的数据\n(C) 静止状态的数据\n(D) 数据保管人",
        "答案": "D",
        "来源页码": 9
    },
    {
        ...
        "中文题目与选项": "对于托管在云环境中的应用程序，谁可能是电子取证（eDiscovery）命令的接收者？\n(A) 用户\n(B) 云服务提供商和云客户都可能是\n(C) 云客户\n(D) 云服务提供商",
        "答案": "B",
        "来源页码": 9
    },
    {
        ...
        "中文题目与选项": "云计算的哪个关键方面最容易受到不安全的 API 的威胁？\n(A) 自动化\n(B) 资源池化\n(C) 弹性\n(D) 冗余性",
        "答案": "A",
        "来源页码": 9
    },
    {
        "题号": "44",
        "英文题目与选项": "Which cloud concept involves the ability for a cloud customer to remove all of its data and IT assets from a cloud provider?\n(A) Removability\n(B) Extraction\n(C) Portability\n(D) Reversibility",
        "中文题目与选项": "哪个云概念涉及云客户能够从云服务提供商处移除其所有数据和IT资产？\n(A) 可移除性\n(B) 提取性\n(C) 可移植性\n(D) 可逆性",
        "答案": "D",
        "来源页码": 10
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在制定数据归档计划和政策时，我们应考虑以下所有因素，除了：\n(A) 备份过程\n(B) 技术的即时性\n(C) 归档位置\n(D) 数据的格式",
        "答案": "D",
        "来源页码": 10
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在 DREAD 模型中，字母 A 代表的概念是什么？\n(A) 受影响的用户\n(B) 授权\n(C) 认证\n(D) 关联性",
        "答案": "A",
        "来源页码": 11
    },
    {
        ...
        "中文题目与选项": "除了一般的数据隐私和保护法规之外，某些类型的数据还受到更严格的法规和监管。以下哪一项不是针对更敏感或专业数据的监管框架？\n(A) FIPS 140-2\n(B) FedRAMP\n(C) PCI DSS\n(D) HIPAA",
        "答案": "A",
        "来源页码": 11
    },
    {
        ...
        "中文题目与选项": "云环境中的许多活动都是通过编程方式执行的，其中复杂且分布式的操作无需逐步手动完成。以下哪种概念描述了这种情况？\n(A) 编排（Orchestration）\n(B) 配置（Provisioning）\n(C) 自动化（Automation）\n(D) 分配（Allocation）",
        "答案": "A",
        "来源页码": 11
    },
    {
        ...
        "中文题目与选项": "在云迁移后重新审查业务影响分析（BIA）时，以下每项都是必须考虑的依赖因素，除了哪一项？\n(A) 云服务提供商的公用设施\n(B) 云服务提供商的供应商\n(C) 云服务提供商的经销商\n(D) 云服务提供商的厂商",
        "答案": "C",
        "来源页码": 11
    },
    {
        ...
        "中文题目与选项": "为了使DLP（数据泄露防护）解决方案能够成功运行，正确实施时需要以下哪一项？\n(A) 物理访问限制\n(B) USB 连接\n(C) 精确的数据分类\n(D) 实体在场",
        "答案": "C",
        "来源页码": 12
    },
    {
        ...
        "中文题目与选项": "在具有资源池的大型分布式系统中，云计算依赖广泛的编排来维护环境并持续提供资源。以下哪一项对于云中网络资源的编排和自动化至关重要？\n(A) DNSSEC\n(B) DNS\n(C) DCOM\n(D) DHCP",
        "答案": "D",
        "来源页码": 12
    },
    {
        ...
        "中文题目与选项": "在云提供商和云客户之间，为了减轻任何问题或安全事件，需要在角色和职责方面明确规定哪个概念或操作流程？\n(A) 事件响应\n(B) 问题管理\n(C) 变更管理\n(D) 冲突响应",
        "答案": "A",
        "来源页码": 12
    },
    {
        ...
        "中文题目与选项": "DLP解决方案有助于防止由以下哪种情况造成的损失？\n(A) 电力故障\n(B) 性能问题\n(C) 不良策略\n(D) 恶意披露",
        "答案": "D",
        "来源页码": 12
    },
    {
        ...
        "中文题目与选项": "以下关于 Type 1 虚拟机管理程序（Hypervisor）的说法哪一项是正确的？\n(A) 硬件供应商和软件供应商是不同的。\n(B) 硬件供应商和软件供应商是相同的。\n(C) 硬件供应商为软件供应商提供开放平台。\n(D) 出于安全考虑，硬件供应商和软件供应商应始终不同。",
        "答案": "B",
        "来源页码": 13
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "收集业务需求有助于组织确定有关组织资产的所有以下信息，但不包括：\n(A) 完整资产清单\n(B) 关键性\n(C) 价值\n(D) 有用性",
        "答案": "D",
        "来源页码": 13
    },
    {
        ...
        "中文题目与选项": "身份与访问管理（IAM）是一种安全学科，用于确保以下哪一项？\n(A) 所有用户都被正确授权。\n(B) 正确的个人在正确的时间因正确的理由访问正确的资源。\n(C) 所有用户都被正确认证。\n(D) 未授权用户可以在正确的时间因正确的理由访问正确的资源。",
        "答案": "B",
        "来源页码": 13
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "使用 IaaS 解决方案时，客户被提供的能力是什么？\n(A) 能够配置处理、存储、网络和其他基础计算资源，消费者可部署并运行任意软件，包括操作系统和应用程序。\n(B) 能够配置处理、存储、网络和其他基础计算资源，审计员可部署并运行任意软件，包括操作系统和应用程序。\n(C) 能够配置处理、存储、网络和其他基础计算资源，提供商可部署并运行任意软件，包括操作系统和应用程序。\n(D) 能够配置处理、存储、网络和其他基础计算资源，但消费者不能部署并运行任意软件，包括操作系统和应用程序。",
        "答案": "A",
        "来源页码": 14
    },
    {
        ...
        "中文题目与选项": "使用 IaaS 解决方案时，为客户提供的关键优势是什么？\n(A) 按使用量计量和定价\n(B) 提高能源和冷却系统效率\n(C) 转移所有权成本\n(D) 能够根据预测使用情况扩展基础设施服务",
        "答案": "A",
        "来源页码": 14
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "以下哪项可视为迁移到云时因尽职调查不足而导致安全或操作问题的示例？\n(A) 监控\n(B) 使用远程密钥管理系统\n(C) 使用的编程语言\n(D) 依赖物理网络控制",
        "答案": "D",
        "来源页码": 14
    },
    {
        ...
        "中文题目与选项": "为在自带设备（BYOD）环境中保护用户设备上的数据，组织应考虑要求以下所有措施，除了：\n(A) 多因素身份验证\n(B) DLP（数据泄漏防护）代理\n(C) 双人完整性\n(D) 本地加密",
        "答案": "C",
        "来源页码": 15
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "云计算的许多方面相较于传统数据中心带来了巨大优势，但也引入了云计算特有的新挑战。\n下列哪一项云计算特性使得正确的数据分类显得尤为重要？\n(A) 多租户机制\n(B) 互操作性\n(C) 可移植性\n(D) 可逆性",
        "答案": "A",
        "来源页码": 15
    },
    {
        ...
        "中文题目与选项": "组织在使用云服务时的主要目标之一是避免供应商锁定，以确保灵活性并保持独立性。\n以下哪项云计算核心概念与供应商锁定关系最密切？\n(A) 可扩展性\n(B) 互操作性\n(C) 可移植性\n(D) 可逆性",
        "答案": "C",
        "来源页码": 15
    },
    {
        "题号": "70",
        "英文题目与选项": "Just like the risk management process, the BCDR planning process has a defined sequence of steps and processes to follow to ensure the production of a comprehensive and successful plan.\nWhich of the following is the correct sequence of steps for a BCDR plan?\n(A) Define scope, gather requirements, assess risk, implement\n(B) Define scope, gather requirements, implement, assess risk\n(C) Gather requirements, define scope, implement, assess risk\n(D) Gather requirements, define scope, assess risk, implement",
        "中文题目与选项": "与风险管理过程类似，BCDR（业务连续性与灾难恢复）规划过程也有一套定义好的步骤和流程，以确保形成全面且成功的计划。\n以下哪项是正确的 BCDR 计划步骤顺序？\n(A) 定义范围，收集需求，评估风险，实施\n(B) 定义范围，收集需求，实施，评估风险\n(C) 收集需求，定义范围，实施，评估风险\n(D) 收集需求，定义范围，评估风险，实施",
        "答案": "A",
        "来源页码": 16
    },
    {
        ...
        "中文题目与选项": "通常可用于云业务连续性和灾难恢复（BC/DR）活动的模型包括以下所有选项，除了：\n(A) 私有架构，云备份\n(B) 云服务提供商，从另一云提供商进行备份\n(C) 云服务提供商，从同一提供商进行备份\n(D) 云服务提供商，从私有提供商进行备份",
        "答案": "D",
        "来源页码": 16
    },
    {
        ...
        "中文题目与选项": "哪一类 PII（可识别个人信息）在被不当使用或披露时可能导致罚款甚至刑事处罚？\n(A) 受保护的\n(B) 法律类\n(C) 受监管的\n(D) 合同类",
        "答案": "C",
        "来源页码": 16
    },
    {
        ...
        "中文题目与选项": "以下哪个协议作为 TLS 的一部分，负责实际的安全通信和数据传输？\n(A) 协商\n(B) 握手\n(C) 传输\n(D) 记录",
        "答案": "D",
        "来源页码": 16
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在许多情况下，测试 BCDR（业务连续性与灾难恢复）计划是适当的或被要求执行的。以下哪种情况不需要进行 BCDR 计划测试？\n(A) 软件更新之后\n(B) 法规变更之后\n(C) 重大配置变更之后\n(D) 每年进行一次",
        "答案": "B",
        "来源页码": 17
    },
    {
        ...
        "中文题目与选项": "以下哪一个 ITIL 组件与计划、协调、执行及验证生产环境中的变更和发布有关？\n(A) 发布管理\n(B) 可用性管理\n(C) 问题管理\n(D) 变更管理",
        "答案": "A",
        "来源页码": 17
    },
    {
        ...
        "中文题目与选项": "BCDR 策略通常不会涉及组织的整个运营，而仅包括被认为对业务至关重要的部分。以下哪个概念与需要恢复的服务量以满足 BCDR 目标有关？\n(A) 恢复服务级别 (RSL)\n(B) 恢复时间目标 (RTO)\n(C) 恢复点目标 (RPO)\n(D) 站点可靠性工程 (SRE)",
        "答案": "A",
        "来源页码": 17
    },
    {
        ...
        "中文题目与选项": "SOC Type 1 报告被认为是“限制使用”的，即仅适用于特定的受众和用途。以下哪类群体不适合接收 SOC Type 1 报告？\n(A) 当前客户\n(B) 审计人员\n(C) 潜在客户\n(D) 服务组织",
        "答案": "C",
        "来源页码": 17
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "由于 SOAP 本身不提供内置安全功能，它必须依赖哪个机制来实现安全？\n(A) 加密\n(B) 标记化\n(C) TLS\n(D) SSL",
        "答案": "A",
        "来源页码": 18
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "ITIL 的哪个组件涉及创建 RFC（变更请求）工单并获取正式批准？\n(A) 问题管理\n(B) 发布管理\n(C) 部署管理\n(D) 变更管理",
        "答案": "D",
        "来源页码": 18
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在云环境中，云客户对其数据如何存储以及系统如何部署失去了大量洞察力和了解。根据 ISO/IEC 云标准，哪个概念与云服务提供商有义务就这些问题通知云客户有关？\n(A) 披露\n(B) 透明性\n(C) 开放性\n(D) 文档化",
        "答案": "B",
        "来源页码": 19
    },
    {
        ...
        "中文题目与选项": "合同阐明了业务关系的总体优先事项和要求，那么哪种文件列举了具体的合规要求、指标和响应时间？\n(A) 服务级别协议\n(B) 服务级别合同\n(C) 服务合规合同\n(D) 服务级别修订",
        "答案": "A",
        "来源页码": 19
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "下列哪一项最能描述沙箱？\n(A) 一个与生产环境隔离的空间，在其中可以安全地进行未经测试的代码和实验。\n(B) 一个可以安全执行恶意代码以观察其行为的空间。\n(C) 一个隔离空间，用于保护事务免受恶意软件侵害。\n(D) 一个在生产环境内可以安全进行未经测试代码和实验的隔离空间。",
        "答案": "A",
        "来源页码": 19
    },
    {
        ...
        "中文题目与选项": "在使用 SaaS 解决方案时，客户获得的能力是什么？\n(A) 使用运行在云基础设施上的供应商应用程序\n(B) 这些应用程序可通过各种客户端设备访问，可使用诸如网络浏览器（例如基于 Web 的电子邮件）等瘦客户端接口，或程序接口\n(C) 消费者管理或控制底层云基础设施，包括网络、服务器、操作系统、存储，甚至单个应用程序功能，但可能有一些用户特定的应用程序配置设置例外\n(D) 使用运行在云基础设施上的消费者应用程序\n(E) 这些应用程序可通过各种客户端设备访问，可使用诸如网络浏览器（例如基于 Web 的电子邮件）等瘦客户端接口，或程序接口\n(F) 消费者不管理或控制底层云基础设施，包括网络、服务器、操作系统、存储，甚至单个应用程序功能，但可能有一些用户特定的应用程序配置设置例外\n(G) 使用运行在云基础设施上的消费者应用程序\n(H) 这些应用程序可通过各种客户端设备访问，可使用诸如网络浏览器（例如基于 Web 的电子邮件）等瘦客户端接口，或程序接口\n(I) 消费者管理或控制底层云基础设施，包括网络、服务器、操作系统、存储，甚至单个应用程序功能，但可能有一些用户特定的应用程序配置设置例外\n(J) 使用运行在云基础设施上的供应商应用程序\n(K) 这些应用程序可通过各种客户端设备访问，可使用诸如网络浏览器（例如基于 Web 的电子邮件）等瘦客户端接口，或程序接口\n(L) 消费者不管理或控制底层云基础设施，包括网络、服务器、操作系统、存储，甚至单个应用程序功能，但可能有一些用户特定的应用程序配置设置例外",
        "答案": "D",
        "来源页码": 20
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "REST API 是一种广泛使用的网络服务通信标准，用于客户端与托管它们的服务器之间通信。REST API 依赖于哪种协议？\n(A) HTTP\n(B) SSH\n(C) SAML\n(D) XML",
        "答案": "A",
        "来源页码": 20
    },
    {
        "题号": "93",
        "英文题目与选项": "When a cloud service provider receives an eDiscovery order pertaining to one of their customers, what should be their first action?\n(A) Take a snapshot of the virtual machines\n(B) Escrow the encryption keys\n(C) Copy the data\n(D) Notify the customer",
        "中文题目与选项": "当云服务提供商收到与其某位客户相关的电子取证(eDiscovery)命令时，他们应采取的首要行动是什么？\n(A) 对虚拟机进行快照\n(B) 托管加密密钥\n(C) 复制数据\n(D) 通知客户",
        "答案": "D",
        "来源页码": 21
    },
    {
        ...
        "中文题目与选项": "在用于监控传输中的数据时，DLP（数据泄露防护）解决方案通常安装在哪里？\n(A) 网络边界\n(B) 数据库服务器\n(C) 应用服务器\n(D) Web 服务器",
        "答案": "A",
        "来源页码": 21
    },
    {
        ...
        "中文题目与选项": "现代 Web 服务系统设计强调高可用性和弹性。以下哪个概念与系统、环境或应用程序中检测问题并可编程地调用冗余系统或进程来缓解问题的能力有关？\n(A) 弹性\n(B) 冗余\n(C) 故障容忍\n(D) 自动化",
        "答案": "C",
        "来源页码": 21
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "欧盟通常被认为是个人数据隐私领域的全球领导者，并宣称隐私是“一项人权”。欧盟首次确立这一原则是在哪一年？\n(A) 1995 年\n(B) 2000 年\n(C) 2010 年\n(D) 1999 年",
        "答案": "A",
        "来源页码": 21
    },
    {
        "题号": "98",
        "英文题目与选项": "If a cloud computing customer wishes to guarantee that a minimum level of resources will always be available, which of the following set of services would compromise the reservation?\n(A) Memory and networking\n(B) CPU and software\n(C) CPU and storage\n(D) CPU and memory",
        "中文题目与选项": "如果云计算客户希望确保始终可以获得最低水平的资源，下列哪组服务属于保留（reservation）的范畴？\n(A) 内存和网络\n(B) CPU 和软件\n(C) CPU 和存储\n(D) CPU 和内存",
        "答案": "D",
        "来源页码": 22
    },
    {
        ...
        "中文题目与选项": "公司总裁要求你通过实施云服务来获得一个健壮且高效的生产灾难恢复配置。你最有可能选择哪种云部署模型？\n(A) 混合云\n(B) 私有云\n(C) 社区云\n(D) 公有云",
        "答案": "A",
        "来源页码": 22
    },
    {
        ...
        "中文题目与选项": "某云客户正在开发软件，用以在多个托管服务提供商之间测试其应用，以确定最适合其需求的选项。哪种云服务类别最为理想？\n(A) DaaS（桌面即服务）\n(B) PaaS（平台即服务）\n(C) IaaS（基础设施即服务）\n(D) SaaS（软件即服务）",
        "答案": "B",
        "来源页码": 22
    },
    {
        ...
        "中文题目与选项": "集群系统可通过多种方法确保各个系统之间的高可用性和负载均衡。在集群系统中使用哪种过程来确保适当的负载均衡并维护整个系统的健康状态以实现高可用性？\n(A) 分布式集群\n(B) 分布式均衡\n(C) 分布式优化\n(D) 分布式资源调度",
        "答案": "D",
        "来源页码": 22
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "对于一组希望合作的大学来说，哪种云部署模型是理想的选择？每个大学可以根据其特定需求获得利益。\n(A) 私有云\n(B) 公有云\n(C) 混合云\n(D) 社区云",
        "答案": "D",
        "来源页码": 23
    },
    {
        ...
        "中文题目与选项": "尽管基于主机的 IDS 和基于网络的 IDS 具有类似的功能和能力，但假设所有能力相同，以下哪一项是网络型 IDS 相对于主机型 IDS 的优势？\n(A) 与主机系统隔离\n(B) 网络访问\n(C) 可扩展性\n(D) 不受系统补丁影响",
        "答案": "A",
        "来源页码": 23
    },
    {
        ...
        "中文题目与选项": "如果贵组织在云计算中希望具备的关键特性是能够无限制地扩展和伸缩，而无需担心可用资源，那么您最可能考虑哪种云部署模型？\n(A) 公有云\n(B) 混合云\n(C) 私有云\n(D) 社区云",
        "答案": "A",
        "来源页码": 24
    },
    {
        ...
        "中文题目与选项": "在软件定义网络（SDN）中，哪两种类型的网络操作被分离，以实现细粒度管理和管理访问权限的委派？\n(A) 过滤与转发\n(B) 过滤与防火墙\n(C) 防火墙与转发\n(D) 转发与协议",
        "答案": "A",
        "来源页码": 24
    },
    {
        ...
        "中文题目与选项": "DNSSEC 的设计目的是为 DNS 协议增加一层安全保护。DNSSEC 扩展旨在缓解哪种类型的攻击？\n(A) 账户劫持\n(B) 窃听\n(C) 欺骗\n(D) 数据泄露",
        "答案": "C",
        "来源页码": 24
    },
    {
        ...
        "中文题目与选项": "虽然数据安全的关注重点主要集中在保持数据的私密性，仅授权人员可以访问，但同样重要的是数据的可信度。哪个概念体现了这一点？\n(A) 有效性\n(B) 完整性\n(C) 可访问性\n(D) 机密性",
        "答案": "B",
        "来源页码": 24
    },
    {
        "题号": "110",
        "英文题目与选项": "Audits are either done based on the status of a system or application at a specific time or done as a study over a period of time that takes into account changes and processes.\nWhich of the following pairs matches an audit type that is done over time, along with the minimum span of time necessary for it?\n(A) SOC Type 2, one year\n(B) SOC Type 1, one year\n(C) SOC Type 2, one month\n(D) SOC Type 2, six months",
        "中文题目与选项": "审计可以基于系统或应用程序在特定时间点的状态进行，也可以作为一个在一段时间内进行的研究，考虑变更和过程。\n以下哪一项组合描述了基于时间段进行的审计类型及其所需的最短时间跨度？\n(A) SOC 类型 2，一年\n(B) SOC 类型 1，一年\n(C) SOC 类型 2，一个月\n(D) SOC 类型 2，六个月",
        "答案": "D",
        "来源页码": 25
    },
    {
        ...
        "中文题目与选项": "以下哪种威胁类型涉及应用在用户首次进入后没有对应用的其他部分进行授权验证？\n(A) 跨站请求伪造\n(B) 功能级访问控制缺失\n(C) 注入攻击\n(D) 跨站脚本攻击",
        "答案": "B",
        "来源页码": 25
    },
    {
        ...
        "中文题目与选项": "如果一家公司需要通过合同和服务级协议（SLA）来保证云服务提供商始终有足够的资源来启动他们的服务并提供一定水平的供应能力，那么合同中应提及哪一项？\n(A) 限制\n(B) 预留\n(C) 保证\n(D) 担保",
        "答案": "B",
        "来源页码": 25
    },
    {
        ...
        "中文题目与选项": "哪种云存储类型需要云客户特别注意，以确保他们不会在编程过程中陷入供应商锁定的情况？\n(A) 非结构化存储\n(B) 对象存储\n(C) 卷存储\n(D) 结构化存储",
        "答案": "D",
        "来源页码": 25
    },
    {
        ...
        "中文题目与选项": "以下哪项陈述最能描述 Type 1 型虚拟机监控程序（Hypervisor）？\n(A) 该虚拟机监控软件运行在与硬件绑定的操作系统内。\n(B) 该虚拟机监控软件作为服务器上的客户端运行，并需要外部服务进行管理。\n(C) 该虚拟机监控软件运行在应用层之上。\n(D) 该虚拟机监控软件直接运行在“裸机”上，无中间层。",
        "答案": "D",
        "来源页码": 25
    },
    {
        ...
        "中文题目与选项": "在 IaaS（基础设施即服务）实施中，下列哪一项不会被用作衡量云客户服务收费的指标？\n(A) 内存\n(B) 用户数量\n(C) 存储\n(D) CPU",
        "答案": "B",
        "来源页码": 26
    },
    {
        ...
        "中文题目与选项": "在哪种数据状态下最有可能使用 TLS 作为保护机制？\n(A) 使用中的数据\n(B) 静态数据\n(C) 存档数据\n(D) 传输中的数据",
        "答案": "D",
        "来源页码": 26
    },
    {
        "题号": "117",
        "英文题目与选项": "4 to 80.6 degrees Fahrenheit (or 18 to 27 degrees Celsius) as the optimal temperature range for data centers. None of these options is the recommendation from ASHRAE.\n(A) Mastered\n(B) Not Mastered",
        "中文题目与选项": "数据中心的最佳温度范围为华氏 64 至 80.6 度（即摄氏 18 至 27 度）。以下选项均非 ASHRAE（美国采暖、制冷与空调工程师学会）的推荐。\n(A) 掌握\n(B) 未掌握",
        "答案": "A",
        "来源页码": 26
    },
    {
        ...
        "中文题目与选项": "以下哪种威胁类型涉及通过应用程序的输入字段发送命令或任意数据，企图让这些代码在正常处理过程中被执行？\n(A) 跨站脚本攻击（XSS）\n(B) 缺少功能级访问控制\n(C) 注入攻击\n(D) 跨站请求伪造",
        "答案": "C",
        "来源页码": 26
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在 IaaS 模型中，负责处理卷存储空间的安全和控制的是哪一项？\n(A) 管理平面\n(B) 操作系统\n(C) 应用程序\n(D) 虚拟机管理程序",
        "答案": "B",
        "来源页码": 27
    },
    {
        ...
        "中文题目与选项": "以下哪一种针对应用程序和服务的威胁类型涉及通过用户的客户端发送无效且被操纵的请求，在应用程序中以用户自己的凭证执行命令？\n(A) 注入攻击\n(B) 缺失函数级访问控制\n(C) 跨站脚本攻击\n(D) 跨站请求伪造",
        "答案": "D",
        "来源页码": 27
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "当用于监控静态数据时，DLP（数据丢失防护）解决方案通常安装在何处？\n(A) 网络防火墙\n(B) 主机系统\n(C) 应用服务器\n(D) 数据库服务器",
        "答案": "B",
        "来源页码": 27
    },
    {
        ...
        "中文题目与选项": "为了符合监管要求，在 IaaS 服务模型中使用卷存储的云客户可以采用以下哪种安全擦除方法？\n(A) 去磁\n(B) 粉碎\n(C) 消磁\n(D) 加密擦除",
        "答案": "D",
        "来源页码": 28
    },
    {
        ...
        "中文题目与选项": "有三个核心概念定义了一个组织在电子取证（eDiscovery）中应负责的数据和信息类型。以下哪三个组成部分构成了强制披露的要求？\n(A) 占有、所有权、控制\n(B) 所有权、使用、创建\n(C) 控制、保管、使用\n(D) 占有、保管、控制",
        "答案": "D",
        "来源页码": 28
    },
    {
        ...
        "中文题目与选项": "以下哪种威胁类型涉及通过用户的客户端发送无效或被操纵的请求，以在该用户的凭证下在应用程序上执行命令？\n(A) 注入攻击\n(B) 跨站请求伪造\n(C) 缺失功能级访问控制\n(D) 跨站脚本攻击",
        "答案": "B",
        "来源页码": 28
    },
    {
        ...
        "中文题目与选项": "系统审计的主要组成部分之一是能够随时间跟踪更改，并将这些更改与持续的合规性和内部流程相匹配。以下哪项云计算特性使这一审计环节比传统数据中心更具挑战性？\n(A) 可移植性\n(B) 虚拟化\n(C) 弹性\n(D) 资源池化",
        "答案": "B",
        "来源页码": 28
    },
    {
        ...
        "中文题目与选项": "在处理个人可识别信息（PII）时，哪一类要求涉及在未能充分保护数据和满足合规要求时可能招致法律制裁或处罚？\n(A) 合同类\n(B) 司法辖区类\n(C) 监管类\n(D) 法律类",
        "答案": "C",
        "来源页码": 29
    },
    {
        ...
        "中文题目与选项": "数字调查已经采用了与其他类型刑事或科学调查相同的许多方法和协议。哪个术语指的是将科学规范和流程应用于数字调查？\n(A) 科学的\n(B) 调查的\n(C) 方法论的\n(D) 法证的",
        "答案": "D",
        "来源页码": 29
    },
    {
        ...
        "中文题目与选项": "尽管美国没有一个单一的、全面的隐私和监管框架，但有许多具体的法规涉及特定的数据类型或人群。以下哪一项不是美国联邦政府的监管体系？\n(A) 健康保险携带与责任法案（HIPAA）\n(B) 萨班斯-奥克斯利法案（SOX）\n(C) 联邦信息安全管理法案（FISMA）\n(D) 支付卡行业数据安全标准（PCI DSS）",
        "答案": "D",
        "来源页码": 29
    },
    {
        ...
        "中文题目与选项": "在 SaaS 环境中，下列哪项任务不是云客户的责任？\n(A) 认证机制\n(B) 品牌定制\n(C) 培训\n(D) 用户访问",
        "答案": "A",
        "来源页码": 29
    },
    {
        ...
        "中文题目与选项": "不同的认证和标准在数据中心设计和运营方面采用不同的方法。尽管许多传统方法使用分层方法，以下哪一个采用宏观层面的数据中心设计方法？\n(A) IDCA（国际数据中心管理协会）\n(B) BICSI（建筑行业咨询服务国际协会）\n(C) Uptime Institute（正常运行时间研究所）\n(D) NFPA（美国国家防火协会）",
        "答案": "A",
        "来源页码": 29
    },
    {
        ...
        "中文题目与选项": "在数据中心（无论是传统数据中心还是云环境）中，有许多用于在传输过程中保护或监控数据的工具和技术。\n以下哪一项不是用于在传输中保护数据的技术？\n(A) VPN\n(B) TLS\n(C) DNSSEC\n(D) HTTPS",
        "答案": "C",
        "来源页码": 30
    },
    {
        "题号": "134",
        "英文题目与选项": "The management plane is used to administer a cloud environment and perform administrative tasks across a variety of systems, but most specifically it's used with the hypervisors.\nWhat does the management plane typically leverage for this orchestration?\n(A) APIs\n(B) Scripts\n(C) TLS\n(D) XML",
        "中文题目与选项": "管理平面用于管理云环境并在各种系统上执行管理任务，尤其是用于与虚拟机管理程序（Hypervisor）的交互。\n管理平面通常利用以下哪种机制来实现这种编排功能？\n(A) API\n(B) 脚本\n(C) TLS\n(D) XML",
        "答案": "A",
        "来源页码": 30
    },
    {
        ...
        "中文题目与选项": "在云数据生命周期的哪个阶段，最适合使用数据丢失防护（DLP）技术来保护数据？\n(A) 使用阶段\n(B) 存储阶段\n(C) 共享阶段\n(D) 创建阶段",
        "答案": "C",
        "来源页码": 30
    },
    {
        ...
        "中文题目与选项": "哪种类型的云存储类似于虚拟硬盘，并且可以以相同的方式使用，具备相同类型的功能和特性？\n(A) 卷（Volume）存储\n(B) 非结构化存储\n(C) 结构化存储\n(D) 对象存储",
        "答案": "A",
        "来源页码": 30
    },
    {
        ...
        "中文题目与选项": "云计算的许多方面和特性可能会使电子取证（eDiscovery）合规变得更加困难或代价更高。以下哪一项云计算特性是最复杂的因素？\n(A) 可计量服务\n(B) 广泛的网络访问\n(C) 多租户\n(D) 可移植性",
        "答案": "C",
        "来源页码": 31
    },
    {
        ...
        "中文题目与选项": "如果运行的应用程序有严格的法律要求，即数据不能存储在包含其他应用程序或系统的系统上，那么在这种情况下，哪一项云计算特性会成为障碍？\n(A) 多租户\n(B) 广泛的网络访问\n(C) 可移植性\n(D) 弹性",
        "答案": "A",
        "来源页码": 31
    },
    {
        ...
        "中文题目与选项": "从合规性的角度来看，在确定数据中心位置时，最重要的考虑因素是什么？\n(A) 自然灾害\n(B) 公用设施接入\n(C) 司法管辖权\n(D) 人员访问",
        "答案": "C",
        "来源页码": 31
    },
    {
        ...
        "中文题目与选项": "云数据生命周期的哪个阶段代表了首次可以实施安全控制的时刻？\n(A) 使用\n(B) 共享\n(C) 存储\n(D) 创建",
        "答案": "C",
        "来源页码": 31
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "在审计报告中，“SOC” 缩写代表什么？\n(A) 服务来源机密性（Service Origin Confidentiality）\n(B) 系统组织机密性（System Organization Confidentiality）\n(C) 服务组织控制（Service Organizational Control）\n(D) 系统组织控制（System Organization Control）",
        "答案": "C",
        "来源页码": 32
    },
    {
        ...
        "中文题目与选项": "在 STRIDE 威胁模型中，“I” 代表什么概念？\n(A) 完整性（Integrity）\n(B) 信息泄露（Information disclosure）\n(C) IT安全（IT security）\n(D) 内部威胁（Insider threat）",
        "答案": "B",
        "来源页码": 32
    },
    {
        ...
        "中文题目与选项": "以下哪种云部署模型为云客户提供了最简便的初始设置和访问？\n(A) 混合云\n(B) 社区云\n(C) 私有云\n(D) 公有云",
        "答案": "D",
        "来源页码": 32
    },
    {
        ...
        "中文题目与选项": "以下哪个过程用于验证请求访问应用程序或数据的用户的身份和凭证？\n(A) 否认（Repudiation）\n(B) 认证（Authentication）\n(C) 标识（Identification）\n(D) 授权（Authorization）",
        "答案": "B",
        "来源页码": 32
    },
    {
        ...
        "中文题目与选项": "动态应用安全测试（DAST）不包括以下哪项内容？\n(A) 扫描\n(B) 探测\n(C) 发现\n(D) 系统知识",
        "答案": "D",
        "来源页码": 33
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "哪种安全概念如果正确实施，即使恶意攻击者获得系统本身的访问权限，也能保护系统中的数据？\n(A) 沙盒化\n(B) 加密\n(C) 防火墙\n(D) 访问控制",
        "答案": "B",
        "来源页码": 33
    },
    {
        ...
        "中文题目与选项": "在云环境中使用哪种过程来维持资源平衡，并确保资源在需要的时间和位置可用？\n(A) 动态集群\n(B) 动态平衡\n(C) 动态资源调度\n(D) 动态优化",
        "答案": "D",
        "来源页码": 33
    },
    {
        ...
        "中文题目与选项": "以下哪种云部署模型要求云客户必须是特定群体或组织的成员，才能在其中托管云服务？\n(A) 社区云\n(B) 混合云\n(C) 私有云\n(D) 公有云",
        "答案": "A",
        "来源页码": 33
    },
    {
        ...
        "中文题目与选项": "无论使用哪种云模型，下列哪一项始终是云客户唯一负责的内容？\n(A) 平台\n(B) 基础设施\n(C) 治理\n(D) 应用程序",
        "答案": "C",
        "来源页码": 34
    },
    {
        ...
        "中文题目与选项": "从安全角度来看，在评估可能的业务连续性与灾难恢复（BCDR）解决方案时，下列哪一项是主要关注点？\n(A) 访问授权\n(B) 审计\n(C) 司法管辖区\n(D) 授权",
        "答案": "C",
        "来源页码": 34
    },
    {
        ...
        "中文题目与选项": "自 2011 年以来，哪种审计类型已被更新的方法大幅取代？\n(A) SOC 类型 1\n(B) SSAE-16\n(C) SAS-70\n(D) SOC 类型 2",
        "答案": "C",
        "来源页码": 34
    },
    {
        ...
        "中文题目与选项": "以下哪一项与云客户对云服务商提出的最低性能标准和必须满足的要求相关？\n(A) 法规要求\n(B) 服务级别协议（SLA）\n(C) 可审计性\n(D) 治理",
        "答案": "B",
        "来源页码": 34
    },
    {
        ...
        "中文题目与选项": "在软件定义网络（SDN）中，网络的哪个方面被从流量转发中抽象出来？\n(A) 路由\n(B) 会话\n(C) 过滤\n(D) 防火墙",
        "答案": "C",
        "来源页码": 34
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "哪种SSAE审计报告对云客户最有利，尽管云提供商不太可能共享它？\n(A) SOC 3\n(B) SOC 1 Type 2\n(C) SOC 2 Type 2\n(D) SOC 1 Type 1",
        "答案": "C",
        "来源页码": 3
    },
    {
        ...
        "中文题目与选项": "您需要获得批准才能开始将公司的数据和系统迁移到云环境。然而，您的首席执行官（CEO）要求将能够轻松从云提供商处移除您的IT资产作为先决条件。这与以下哪个云概念有关？\n(A) 可移除性\n(B) 提取性\n(C) 可移植性\n(D) 可逆性",
        "答案": "D",
        "来源页码": 9
    },
    {
        ...
        "中文题目与选项": "如果用户拥有 RSA 令牌，以下哪一项可以用作多因素身份验证的第二个组件？\n(A) 门禁卡\n(B) USB 闪存盘\n(C) 视网膜扫描\n(D) RFID",
        "答案": "C",
        "来源页码": 10
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "您在一家云服务提供商工作，收到了一份与您的某个客户相关的电子取证（eDiscovery）命令。以下哪一项是首先要采取的最合适行动？\n(A) 对虚拟机进行快照\n(B) 托管加密密钥\n(C) 复制数据\n(D) 通知客户",
        "答案": "D",
        "来源页码": 20
    },
    {
    ...
    },
    {
        ...
        "中文题目与选项": "为了确保持续符合监管要求，必须定期测试云数据生命周期的哪个阶段？\n(A) 存档（Archive）\n(B) 共享（Share）\n(C) 存储（Store）\n(D) 销毁（Destroy）",
        "答案": "A",
        "来源页码": 31
    }
]
